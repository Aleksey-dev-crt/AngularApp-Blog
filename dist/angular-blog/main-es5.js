...
var PostsService = /** @class */ (function () {
    ...
    PostsService.prototype.getAll = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].fbDbUrl + "/posts.json")
            ...
            return Object
                .keys(response)
                .map(function (key) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, response[key], { id: key, date: new Date(response[key].date) })); });
        }));
    };
    ...
    PostsService.prototype.remove = function (id) {
