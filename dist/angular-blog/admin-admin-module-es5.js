...
var CreatePageComponent = /** @class */ (function () {
    ...
    CreatePageComponent.prototype.submit = function () {
        ...
        this.postsService.create(post).subscribe(function () {
            _this.form.reset();
            _this.alert.success('Пост был создан');
        });
    };
...
var DashboardPageComponent = /** @class */ (function () {
    ...
    DashboardPageComponent.prototype.remove = function (id) {
        var _this = this;
        this.postsService.remove(id).subscribe(function () {
            _this.posts = _this.posts.filter(function (post) { return post.id !== id; });
            _this.alert.danger('Пост был удален');
        });
    };
...
var EditPageComponent = /** @class */ (function () {
    function EditPageComponent(route, postsService, alert) {
        this.route = route;
        this.postsService = postsService;
        this.alert = alert;
    ...
    EditPageComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (params) {
            return _this.postsService.getById(params['id']);
    ...
    EditPageComponent.prototype.submit = function () {
        ...
        this.submitted = true;
        this.uSub = this.postsService.update(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.post, { text: this.form.value.text, title: this.form.value.title })).subscribe(function () {
            _this.submitted = false;
            _this.alert.success('Пост был обновлен');
        });
    };
